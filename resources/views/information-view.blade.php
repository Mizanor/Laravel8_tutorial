            ...
            <div class="card-body">
              <table id="myTable" class="table table-striped table-bordered" style="width:100%">
                ...
                <tr class="">
                        ...
                        <td><a href="{{(!empty($data->image))?url('upload/'.$data->image):url('upload/no_image.png')}}"> <img src="{{(!empty($data->image))?url('upload/'.$data->image):url('upload/no_image.png')}}" style="width: 100px; height: 90px; border: 1px solid #000;"> </a>
                        </td>
